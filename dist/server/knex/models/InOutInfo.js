...
Model.knex(knex);
var InOutInfo = /*#__PURE__*/function (_Model) {
  function InOutInfo() {
    _classCallCheck(this, InOutInfo);
    return _callSuper(this, InOutInfo, arguments);
  }
  _inherits(InOutInfo, _Model);
  return _createClass(InOutInfo, null, [{
    key: "tableName",
    get: function get() {
      return 'in_out_infos';
    }
